...
<div class="form-rekap-biaya-search">
    ...
    <?php /* echo $form->field($model, 'Nikkes')->textInput(['maxlength' => true, 'placeholder' => 'Nikkes']) */ ?>

    <?php /* echo $form->field($model, 'Nama_Pasien')->textInput(['maxlength' => true, 'placeholder' => 'Nama Pasien']) */ ?>
